                  ...
                  <div className="o-content">
                    <div className="o-grid a-content">
                      <div className="o-grid__col-md-5">
                        ...
                        <h4 className="c-work__title">Sarjana Komputer</h4>
                      ...
                      <div className="o-grid__col-md-7">
                        <p>
                          ...
                          dibawah naungan Yayasan Pendidikan Tinggi PGRI. Yayasan Pendidikan Tinggi
                          PGRI mengemban misi melaksanakan amanat luhur yang terkandung didalam
                          Pembukaan Undang-undang Dasar 1945, yaitu misi untuk mencerdaskan
