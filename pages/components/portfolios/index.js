            ...
            <div className="o-section__content t-section__content o-section__full-bottom-space">
              <div className="o-grid o-grid--gallery">
                ...
                {portfoliosList.map((item, i) => (
                  <div className="o-grid__col-sm-6 o-grid__col-xs-6 a-content" key={i} data-aos="flip-right" data-aos-delay="0">
                    <a className="c-image-overlay t-image-overlay js-lightbox" 
                      data-lightbox-gallery="portfolio" data-lightbox-hidpi="" 
