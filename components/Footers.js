              ...
              <div className="c-footer__contact">
                  ...
                  <div className="o-grid__col-md-3  o-grid__col-sm-6">
                    <div className="o-content">
                      <div className="o-content__body a-content" data-aos="fade-down" data-aos-delay="200">
                        <h4>Location</h4>
                        <address>
                  ...
                  <div className="o-grid__col-md-3  o-grid__col-sm-6">
                    <div className="o-content">
                      <div className="o-content__body a-content" data-aos="fade-down" data-aos-delay="400">
                        <h4>Phone</h4>
                        <p>
                  ...
                  <div className="o-grid__col-md-3  o-grid__col-sm-6">
                    <div className="o-content">
                        <div className="o-content__body a-content" data-aos="fade-down" data-aos-delay="600">
                          <h4>Web</h4>
                          <p>
                              <a href="https://zikriramdani.github.io"
                              target="_blank" className="t-link-container" rel="noreferrer">
                                  <span className="t-link-container__item--blended">
                                      zikriramdani.github.io
                                  </span>   
                              </a>  
                              <a href="http://zikriramdani.blogspot.com"
                              target="_blank" className="t-link-container" rel="noreferrer">
                                  <span className="t-link-container__item--blended">
                  ...
                  <div className="o-grid__col-md-3  o-grid__col-sm-6">
                      <div className="o-content">
                          <div className="o-content__body a-content" data-aos="fade-down" data-aos-delay="800">
                              <a href="mailto:zikriramdani13@yahoo.com" target="_blank" className="t-link-container" rel="noreferrer">
                                  <h4>Email</h4>
                                  <p>
                                      <span className="t-link-container__item--blended">
              ...
              <div className="o-content">
                  <div className="c-footer__bottom">
                      ...
                      <ul className="c-footer__social-buttons  c-social-buttons  o-content__body" data-aos="fade-down" data-aos-delay="1200">
                          ...
                          <li className="a-footer a-content">
                              <a href="http://zikriramdani.blogspot.com" target="_blank" className="c-social-button  t-social-button" rel="noreferrer">
                                  <i className="fa  fa-lg  fa-dribbble"></i>
                              </a>
                          </li>
                      </ul>
