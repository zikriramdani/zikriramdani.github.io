  ...
  v.fn.floatingWhatsApp = function (e) {
    ...
    if (
      ...
      s
        ...
        .css({ width: i.size, height: i.size, 'background-color': i.backgroundColor }),
      ...
      l.addClass('floating-wpp-popup'),
        ...
        g.keypress(function (e) {
          (i.message = v(this).val()),
            13 != e.keyCode || e.shiftKey || o || (e.preventDefault(), m.click());
        }),
        m.click(function () {
          (i.message = g.val()), C();
        }),
    ...
    i.zIndex && v(this).css('z-index', i.zIndex),
      'right' === i.position && (this.css({ left: 'auto', right: '15px' }), l.css('right', '0'));
  };
})(jQuery);
