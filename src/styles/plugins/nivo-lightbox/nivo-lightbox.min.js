  ...
  o.prototype = {
    ...
    processContent: function (n, r) {
      ...
      if (s.match(/\.(jpeg|jpg|gif|png)$/i) !== null) {
        var u = e('<img>', { src: s });
        u.one('load', function () {
          var r = e('<div className="nivo-lightbox-image" />');
          r.append(u);
        ...
        u.error(function () {
          var t = e(
            '<div className="nivo-lightbox-error"><p>' + i.options.errorMessage + '</p></div>'
          );
        ...
        e.ajax({
          ...
          cache: false,
          success: function (r) {
            var i = e('<div className="nivo-lightbox-ajax" />');
            i.append(r);
        ...
        if (e(s).length) {
          var c = e('<div className="nivo-lightbox-inline" />');
    ...
    constructLightbox: function () {
      ...
      var i = e(
        '<a href="#" className="nivo-lightbox-nav nivo-lightbox-prev">Previous</a><a href="#" className="nivo-lightbox-nav nivo-lightbox-next">Next</a>'
      );
      var s = e('<a href="#" className="nivo-lightbox-close" title="Close">Close</a>');
