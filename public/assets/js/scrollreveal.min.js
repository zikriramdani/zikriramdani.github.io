      ...
      (this.ScrollReveal = (function () {
        ...
        function c(e) {
          ...
          parseInt(t.distance) &&
            ...
            t.rotate.x &&
              ((n.initial += ' rotateX(' + t.rotate.x + 'deg)'), (n.target += ' rotateX(0)')),
            t.rotate.y &&
              ((n.initial += ' rotateY(' + t.rotate.y + 'deg)'), (n.target += ' rotateY(0)')),
            t.rotate.z &&
              ((n.initial += ' rotateZ(' + t.rotate.z + 'deg)'), (n.target += ' rotateZ(0)')),
        ...
        function g(t, n) {
          ...
          (r.blocked = !0),
            ...
            (t.sequence.timer.clock = window.setTimeout(
              function () {
        ...
        function w(e, t, n) {
          ...
          t.timer &&
            ((i = Math.abs(t.timer.started - new Date())), window.clearTimeout(t.timer.clock)),
            (t.timer = {
              started: new Date()
            }),
